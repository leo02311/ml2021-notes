...
graph TD
    ...
    "Core Concepts" --> "Episode"
    "Core Concepts" --> "Support Set"
    "Core Concepts" --> "Query Set"
    
    "Categories" --> "Learning to initialize"
    "Categories" --> "Learning to compare"
    "Categories" --> "NAS"
    "Categories" --> "Data Augmentation"
    
    "Learning to initialize" --> "MAML"
    "Learning to initialize" --> "Reptile"
    "NAS" --> "Reinforcement Learning"
