---
title: 第三堂課：機器學習任務攻略 (Overfitting & Optimization)
tags:
  - MachineLearning
  - DeepLearning
  - Overfitting
...
# 第三堂課：機器學習任務攻略 (Overfitting & Optimization)
...
```mermaid
graph TD
    Start["結果不理想"] --> CheckTrain["1. 檢查 Training Loss"]
    ...
    CheckTrain -->|Loss 很小| CheckTest["2. 檢查 Testing Loss"]
